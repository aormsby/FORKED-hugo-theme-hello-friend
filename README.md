...
Just to be clear -- I set the default branch of this repo to my **Working** branch that I use on my own site. It contains some of the improvements that were successfully pulled back to the source along with a few others that are too custom for the base theme. The **Master** branch is in line with the original theme repo.
